...
#LER NUVEM DE PONTOS
arquivo= "/home/feijo/Documents/UFCPESQUISA/volumecarvao/100KdumbDino.txt" 
...
#     fig.savefig('/home/feijo/Documents/volumecarvao/selecao_teste/fig_{}.png'.format(i))
    ...
    np.savetxt('/home/feijo/Documents/UFCPESQUISA/volumecarvao/selecao_teste/points_fig_{}.txt'.format(i), points_slice, delimiter=' ') 
    fig.savefig('/home/feijo/Documents/UFCPESQUISA/volumecarvao/selecao_teste/fig2{}.png'.format(i))

    plt.close()

#identificar o numero de slices na path
folder = '/home/feijo/Documents/UFCPESQUISA/volumecarvao/selecao_teste' # path dos slices
...
#   img = np.asarray(Image.open("/home/feijo/Documentos/carvao_ufc/selecao_teste/points_fig_{}.txt".format(i)).convert('L'))
    img3 = np.loadtxt("/home/feijo/Documents/UFCPESQUISA/volumecarvao/selecao_teste/points_fig_{}.txt".format(z), delimiter=' ')
